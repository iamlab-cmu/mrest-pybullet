...
class BarrettLeftHandController(object):
    ...
    def update_current_state(self, qCurrent, qdotCurrent):
        ...
        self.currentAngleVel = qdotCurrent
    ...
    def update(self, time_period_s):
        ...
        self.barrettLeftHandTorques = [self._joint_controllers[j].get_pid_output() for j in range(self.nJoints)]
